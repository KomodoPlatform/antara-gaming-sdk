...
namespace antara::gaming::sfml {
    ...
    public:
        ...
        template<typename ... DrawableType>
        void
        set_properties(entt::entity entity, transform::properties &props, doom::meta::list<DrawableType...>) noexcept;
        ...
        void
        on_rectangle_construct(entt::entity entity, entt::registry &registry, geometry::rectangle &rectangle) noexcept;

        void
        on_position_2d_construct(entt::entity entity, entt::registry &registry, transform::position_2d &pos) noexcept;
        ...
        void on_vertex_array_construct(entt::entity entity, entt::registry &registry,
                                       geometry::vertex_array &cmp_vertex_array) noexcept;

        void
        on_properties_replaced(entt::entity entity, entt::registry &registry, transform::properties &props) noexcept;
    ...
    private:
        ...
        sf::RenderWindow window_{sf::VideoMode(canvas_.window.size.x(), canvas_.window.size.y()),
                                 canvas_.window_title, canvas_.is_fullscreen
                                                       ...
                                                       !canvas_.no_style ? static_cast<sf::Uint32>(sf::Style::Default)
                                                                         : static_cast<sf::Uint32>(sf::Style::None)};
