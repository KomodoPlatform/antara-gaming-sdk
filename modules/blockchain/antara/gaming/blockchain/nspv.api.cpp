...
namespace antara::gaming::blockchain {
    void nspv_api::from_json(const nlohmann::json &j, nspv_api::login_answer &cfg) {
    ...
    void nspv_api::from_json(const nlohmann::json &j, nspv_api::listunspent_answer &cfg) {
        j.at("result").get_to(cfg.result);
    ...
    nspv_api::get_newaddress_answer nspv_api::get_newaddress() {
        LOG_SCOPE_FUNCTION(INFO);
        auto json_data = template_request("getnewaddress");
        return get_newaddress_answer();
    }

    nspv_api::login_answer nspv_api::login(const std::string &endpoint, const std::string &wif) {
        LOG_SCOPE_FUNCTION(INFO);
    ...
    nspv_api::listunspent_answer nspv_api::listunspent(const std::string &endpoint, const std::string &address) {
        LOG_SCOPE_FUNCTION(INFO);
    ...
    nspv_api::spend_answer nspv_api::spend(const std::string &endpoint, const std::string &address, double amount) {
        LOG_SCOPE_FUNCTION(INFO);
    ...
    nlohmann::json nspv_api::template_request(std::string method_name) noexcept {
        LOG_SCOPE_FUNCTION(INFO);
    ...
    RpcReturnType nspv_api::rpc_process_answer(const RestClient::Response &resp) noexcept {
        LOG_SCOPE_FUNCTION(INFO);
