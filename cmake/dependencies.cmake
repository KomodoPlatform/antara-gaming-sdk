...
if (NOT ANTARA_USE_VCPKG)
    ...
    add_library(fake_entt INTERFACE)
    target_link_libraries(fake_entt INTERFACE EnTT::EnTT)
    add_library(EnTT::EnTT ALIAS fake_entt)
...
if (EMSCRIPTEN)
    ...
    target_compile_definitions(antara_log PUBLIC -DLOGURU_USE_FMTLIB=1)
endif ()
target_link_libraries(antara_log PUBLIC fmt::fmt-header-only PRIVATE Threads::Threads ${CMAKE_DL_LIBS})
if (WIN32)
